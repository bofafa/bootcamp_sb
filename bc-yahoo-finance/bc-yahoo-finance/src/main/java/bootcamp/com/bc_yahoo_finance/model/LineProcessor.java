...
public class LineProcessor {
  ...
  public LineProcessor(List<Transaction> transactions) {
  ...
  public Set<PricePoint> getIntervals(int minutePerInterval) {
    ...
    for (int i = 0; i < size-1; i++) {
      LocalDateTime head = transactions.get(i).getTimestamp();
  ...
  public static void main(String[] args) {
    ...
    Set<PricePoint> points = new LineProcessor(transactions).getIntervals(5);
